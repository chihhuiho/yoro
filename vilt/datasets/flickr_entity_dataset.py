...
class FlickrEntityDataset(BaseDataset):
    def __init__(self, *args, split="", **kwargs):
        ...
        self.split = split
        if split == "train":
            names = ["train_seperate"]
        elif split == "val":
            names = ["val_seperate"]
        elif split == "test":
            names = ["test_seperate"]   

        print("Loading flickr entity")
    ...
    def __getitem__(self, index):
        img_id = self.table["img_id"][index].as_py()
        phrase_id = self.table["phrase_id"][index].as_py()
        ...
        all_gt_bbox = self.table["all_gt_bbox"][index].as_py()
